...
public class CameraPushMainActivity extends FragmentActivity implements
    ...
    private TencentLVBSDKBeautyManager tencentLVBSDKBeautyManager;
...
//        mBeautyPanelView.setBeautyManager(mLivePusher.getBeautyManager());
    ...
    private void startPush() {
        ...
        if (TextUtils.isEmpty(tRTMPURL) || (!tRTMPURL.trim().toLowerCase().startsWith("rtmp://"))) {
            ...
            // TODO mmbeauty 接入MMbeauty这里需要开启自定义视频处理
            mLivePusher.enableCustomVideoProcess(true, V2TXLiveDef.V2TXLivePixelFormat.V2TXLivePixelFormatTexture2D,
    ...
    private class MyPusherObserver extends V2TXLivePusherObserver {
        ...
        public void onGLContextCreated() {
            mLinearBottomBar.post(new Runnable() {
                @Override
                public void run() {
                    tencentLVBSDKBeautyManager = new TencentLVBSDKBeautyManager(CameraPushMainActivity.this);
                }
            });
        }
        ...
        public int onProcessVideoFrame(V2TXLiveDef.V2TXLiveVideoFrame srcFrame, V2TXLiveDef.V2TXLiveVideoFrame dstFrame) {
            if (tencentLVBSDKBeautyManager != null) {
                dstFrame.texture.textureId = tencentLVBSDKBeautyManager.renderWithTexture(srcFrame.texture.textureId,srcFrame.width,srcFrame.height,srcFrame.rotation == 270);
            }
            return 0;
        }
        ...
        public void onGLContextDestroyed() {
            tencentLVBSDKBeautyManager.textureDestoryed();
        }
    }
    ...
    private void setPushScene(int type, boolean enableAdjustBitrate) {
        ...
        switch (type) {
            case TXLiveConstants.VIDEO_QUALITY_STANDARD_DEFINITION:     // 360P
                if (mLivePusher != null) {
                    V2TXLiveDef.V2TXLiveVideoEncoderParam param = new V2TXLiveDef.V2TXLiveVideoEncoderParam(V2TXLiveDef.V2TXLiveVideoResolution.V2TXLiveVideoResolution640x360);
                    param.videoResolutionMode = mIsLandscape ? V2TXLiveVideoResolutionModeLandscape : V2TXLiveVideoResolutionModePortrait;
                    mLivePusher.setVideoQuality(param);
            ...
            case TXLiveConstants.VIDEO_QUALITY_SUPER_DEFINITION:        // 720p
                if (mLivePusher != null) {
                    V2TXLiveDef.V2TXLiveVideoEncoderParam param = new V2TXLiveDef.V2TXLiveVideoEncoderParam(V2TXLiveDef.V2TXLiveVideoResolution.V2TXLiveVideoResolution1280x720);
                    param.videoResolutionMode = mIsLandscape ? V2TXLiveVideoResolutionModeLandscape : V2TXLiveVideoResolutionModePortrait;
                    mLivePusher.setVideoQuality(param);
            ...
            case TXLiveConstants.VIDEO_QUALITY_ULTRA_DEFINITION:        // 1080p
                if (mLivePusher != null) {
                    V2TXLiveDef.V2TXLiveVideoEncoderParam param = new V2TXLiveDef.V2TXLiveVideoEncoderParam(V2TXLiveDef.V2TXLiveVideoResolution.V2TXLiveVideoResolution1920x1080);
                    param.videoResolutionMode = mIsLandscape ? V2TXLiveVideoResolutionModeLandscape : V2TXLiveVideoResolutionModePortrait;
                    mLivePusher.setVideoQuality(param);
