...
public class HttpRequests {
    ...
    public HttpRequests(String domain) {
        ...
        HttpLoggingInterceptor interceptor = new HttpLoggingInterceptor(new HttpInterceptorLog());
    ...
    public interface OnResponseCallback<T> {
        void onResponse(final int retcode, final @Nullable String retmsg, final @Nullable T data);
    }
}
