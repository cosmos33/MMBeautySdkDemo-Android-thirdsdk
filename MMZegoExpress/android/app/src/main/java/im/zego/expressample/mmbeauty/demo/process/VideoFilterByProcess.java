...
import im.zego.expressample.mmbeauty.demo.ve_gl.EglBase;
import im.zego.expressample.mmbeauty.demo.ve_gl.EglBase14;
import im.zego.expressample.mmbeauty.demo.ve_gl.GlRectDrawer;
import im.zego.expressample.mmbeauty.demo.ve_gl.GlUtil;
...
public class VideoFilterByProcess extends IZegoCustomVideoProcessHandler implements SurfaceTexture.OnFrameAvailableListener {
    ...
    public VideoFilterByProcess(ZegoBeautyManager beautyManager) {
        stopFlag=false;
    ...
    public void onFrameAvailable(SurfaceTexture surfaceTexture) {
        ...
        int textureID = beautyManager.renderWithOESTexture(mInputTextureId,mOutputWidth,mOutputHeight,isFront,90);
