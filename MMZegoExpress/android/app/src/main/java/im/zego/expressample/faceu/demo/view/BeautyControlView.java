package im.zego.expressample.faceu.demo.view;
...
import im.zego.expressample.faceu.demo.faceunity.OnFUControlListener;
import im.zego.expressample.faceu.demo.faceunity.entity.Effect;
import im.zego.expressample.faceu.demo.faceunity.entity.FaceMakeup;
import im.zego.expressample.faceu.demo.faceunity.entity.Filter;
import im.zego.expressample.faceu.demo.faceunity.entity.MakeupItem;
import im.zego.expressample.faceu.demo.view.adapter.BaseRecyclerAdapter;
import im.zego.expressample.faceu.demo.view.adapter.VHSpaceItemDecoration;
import im.zego.expressample.faceu.demo.view.entity.BeautyParameterModel;
import im.zego.expressample.faceu.demo.view.entity.EffectEnum;
import im.zego.expressample.faceu.demo.view.entity.FaceMakeupEnum;
import im.zego.expressample.faceu.demo.view.entity.FilterEnum;
import im.zego.expressample.faceu.demo.view.seekbar.DiscreteSeekBar;
import im.zego.expressample.faceu.demo.view.utils.OnMultiClickListener;
import im.zego.expresssample.faceu.demo.R;

import static im.zego.expressample.faceu.demo.view.entity.BeautyParameterModel.STR_FILTER_LEVEL;
import static im.zego.expressample.faceu.demo.view.entity.BeautyParameterModel.getValue;
import static im.zego.expressample.faceu.demo.view.entity.BeautyParameterModel.isOpen;
import static im.zego.expressample.faceu.demo.view.entity.BeautyParameterModel.sFilter;
import static im.zego.expressample.faceu.demo.view.entity.BeautyParameterModel.sFilterLevel;
import static im.zego.expressample.faceu.demo.view.entity.BeautyParameterModel.sHeavyBlur;
import static im.zego.expressample.faceu.demo.view.entity.BeautyParameterModel.sSkinDetect;
import static im.zego.expressample.faceu.demo.view.entity.BeautyParameterModel.setValue;
