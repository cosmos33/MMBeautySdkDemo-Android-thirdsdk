package im.zego.expressample.mmbeauty.demo.view;
...
public class CustomPopWindow implements PopupWindow.OnDismissListener {
    ...
    private PopupWindow build() {
        ...
        if (mContentView == null) {
            ...
            textView = mContentView.findViewById(R.id.msg);
        }
    ...
    public CustomPopWindow setMsg(String msg) {
        if (textView != null) {
    ...
    public static class PopupWindowBuilder {
        ...
        private PopupWindowBuilder setView(int resLayoutId) {
