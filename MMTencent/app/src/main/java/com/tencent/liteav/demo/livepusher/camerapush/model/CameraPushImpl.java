 ...
 */
public abstract class CameraPushImpl implements CameraPush, ITXLivePushListener {
...
//            mLivePusher.setBeautyFilter(mBeautyStyle, mBeautyLevel, mWhiteningLevel, mRuddyLevel);
    ...
    protected abstract void showViewLog(boolean enable);

    abstract protected void startPreview(TXCloudVideoView mPusherView);

    abstract protected void setVisibility(int visibility);
    ...
    public void onPushEvent(int event, Bundle param) {
        ...
        String pushEventLog = "receive_event" + event + ", " + msg;
