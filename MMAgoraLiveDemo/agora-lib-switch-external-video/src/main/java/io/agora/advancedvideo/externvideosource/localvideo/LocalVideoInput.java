...
public class LocalVideoInput implements IExternalVideoInput, TextureView.SurfaceTextureListener {
    ...
    private final AgoraLiveBeautyManager agoraLiveBeautyManager;
    ...
    public LocalVideoInput(Context context, String filePath) {
        mFilePath = filePath;
        agoraLiveBeautyManager = new AgoraLiveBeautyManager(context);
    }
    ...
    public int onFrameAvailable(GLThreadContext context, int textureId, float[] transform) {
        ...
        int outTexture = agoraLiveBeautyManager.renderWithOESTexture(textureId, mVideoHeight, mVideoWidth
                , true, 0);
        ...
        mProgram.drawFrame(outTexture, transform);
