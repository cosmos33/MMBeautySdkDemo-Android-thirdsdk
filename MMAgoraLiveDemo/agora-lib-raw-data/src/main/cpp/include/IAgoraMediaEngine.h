 ...
 */
    ...
    public:
        ...
        */
        virtual bool onPlaybackAudioFrameBeforeMixingEx(const char *channelId, unsigned int uid,
 ...
 */
    ...
    public:
         ...
         */
        virtual bool onRenderVideoFrameEx(const char *channelId, unsigned int uid,
                                          VideoFrame &videoFrame) { return true; }
    };

    class IVideoFrame {
    public:
        enum PLANE_TYPE {
            Y_PLANE = 0, U_PLANE = 1, V_PLANE = 2, NUM_OF_PLANES = 3
        };
        enum VIDEO_TYPE {
...
/** **DEPRECATED** */
    ...
    public:
        ...
        createRenderInstance(const ExternalVideoRenerContext &context) = 0;
    };
...
/** * The struct of VideoEncodedFrame. */
    struct VideoEncodedFrame {
        VideoEncodedFrame() : codecType(VIDEO_CODEC_H264), width(0), height(0), buffer(nullptr),
                              length(0), frameType(CODEC_VIDEO_FRAME_TYPE_BLANK_FRAME),
                              rotation(VIDEO_ROTATION_0), renderTimeMs(0) {}
