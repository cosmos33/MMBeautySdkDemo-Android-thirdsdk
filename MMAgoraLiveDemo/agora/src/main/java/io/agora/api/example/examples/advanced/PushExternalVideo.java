...
@Example(
        ...
        group = ADVANCED,
        name = "自定义视频采集(Push)",
        actionId = R2.id.action_mainFragment_to_PushExternalVideo,
...
public class PushExternalVideo extends BaseFragment implements View.OnClickListener, TextureView.SurfaceTextureListener,
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        agoraLiveBeautyManager = new AgoraLiveBeautyManager(getContext());
    }
...
//        pushFrame(outTexture);
    ...
    private void pushFrame(int outTexture) {
        if (joined) {
            ...
            frame.textureID = outTexture;
            frame.format = AgoraVideoFrame.FORMAT_TEXTURE_2D;
