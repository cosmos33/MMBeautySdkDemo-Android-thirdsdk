...
public class ExampleActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        switch (exampleBean.getActionId()) {
            case R2.id.action_mainFragment_to_joinChannelAudio:
                fragment = new JoinChannelAudio();
                break;
            case R2.id.action_mainFragment_to_joinChannelVideo:
                fragment = new JoinChannelVideo();
                break;
            case R2.id.action_mainFragment_to_CustomAudioSource:
                fragment = new CustomAudioSource();
                break;
            case R2.id.action_mainFragment_to_CustomRemoteRender:
                fragment = new CustomRemoteVideoRender();
                break;
            case R2.id.action_mainFragment_to_ProcessRawData:
                fragment = new ProcessRawData();
                break;
            case R2.id.action_mainFragment_to_PushExternalVideo:
                fragment = new PushExternalVideo();
                break;
            case R2.id.action_mainFragment_to_QuickSwitch:
                fragment = new VideoQuickSwitch();
                break;
            case R2.id.action_mainFragment_to_MultiChannel:
                fragment = new JoinMultipleChannel();
                break;
            case R2.id.action_mainFragment_to_SetAudioProfile:
                fragment = new SetAudioProfile();
                break;
            case R2.id.action_mainFragment_to_PlayAudioFiles:
                fragment = new PlayAudioFiles();
                break;
            case R2.id.action_mainFragment_to_MediaPlayerKit:
                fragment = new MediaPlayerKit();
                break;
            case R2.id.action_mainFragment_to_RTMPInjection:
                fragment = new RTMPInjection();
                break;
            case R2.id.action_mainFragment_to_RTMPStreaming:
                fragment = new RTMPStreaming();
                break;
            case R2.id.action_mainFragment_to_StreamEncrypt:
                fragment = new StreamEncrypt();
                break;
            case R2.id.action_mainFragment_to_SwitchExternalVideo:
                fragment = new SwitchExternalVideo();
                break;
            case R2.id.action_mainFragment_to_SwitchCameraScreenShare:
                fragment = new SwitchCameraScreenShare();
                break;
            case R2.id.action_mainFragment_to_VideoMetadata:
                fragment = new VideoMetadata();
                break;
            case R2.id.action_mainFragment_to_InCallReport:
                fragment = new InCallReport();
                break;
            case R2.id.action_mainFragment_to_AdjustVolume:
                fragment = new AdjustVolume();
                break;
            case R2.id.action_mainFragment_to_PreCallTest:
                fragment = new PreCallTest();
                break;
            case R2.id.action_mainFragment_to_hostacrosschannel:
                fragment = new HostAcrossChannel();
                break;
            case R2.id.action_mainFragment_to_set_video_profile:
                fragment = new SetVideoProfile();
                break;
            case R2.id.action_mainFragment_to_channel_encryption:
