package com.zego.videofilter.view.seekbar.internal.compat;
...
import com.zego.videofilter.view.seekbar.internal.drawable.AlmostRippleDrawable;
...
public class SeekBarCompat {
    ...
    /**
     * androidx.core.view.ViewCompat SHOULD include this once and for all!!
     * But it doesn't...
     *
     * @param view
     * @param background
