...
public class AudioStreamingActivity extends Activity implements
    ...
    private void initStreamingManager() {
        ...
        //注册camera数据接口回调,获取nv21数据，由美颜模人脸检测使用
    ...
    public int onDrawFrame(int texId, int texWidth, int texHeight, float[] transformMatrix) {
        ...
        int resultTextureId = mFBO.drawFrame(texId, texWidth, texHeight, onDrawFrameListener, false);
    ...
    @Override
    public synchronized boolean onPreviewFrame(byte[] bytes, int width, int height, int rotation, int fmt, long tsInNanoTime) {
...
//            qiniuBeautyManager.renderWithBytesTexture(cameraData,texId,dataWidth,dataHeight,texWidth,texHeight,true);
            return texId;
        }
    };
