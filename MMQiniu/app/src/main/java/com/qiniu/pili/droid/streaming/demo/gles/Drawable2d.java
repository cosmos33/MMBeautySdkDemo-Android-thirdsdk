...
public class Drawable2d {
    ...
    private static final float FULL_RECTANGLE_TEX_COORDS_270[] = {
    ...
    public void setRotation(int rotation) {
        if (rotation == 90) {
            mTexCoordArray = GlUtil.createFloatBuffer(FULL_RECTANGLE_TEX_COORDS_90);
        } else if (rotation == 270) {
            mTexCoordArray = GlUtil.createFloatBuffer(FULL_RECTANGLE_TEX_COORDS_270);
        } else {
            mTexCoordArray = FULL_RECTANGLE_TEX_BUF;
        }
