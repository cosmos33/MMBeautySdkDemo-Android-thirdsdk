...
public class QiNiuActivity extends FragmentActivity {
    private static final String TAG = "QiNiuActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_qiuniu);
    ...
    public void onClickCheckAuth(View v) {
        StreamingEnv.checkAuthentication(new PLAuthenticationResultCallback() {
            ...
            public void onAuthorizationResult(int result) {
                ...
                Toast.makeText(QiNiuActivity.this, "auth : " + authState, Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void onClickGenPublishURL(View v) {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                if (publishUrl != null) {
                    Cache.saveURL(QiNiuActivity.this, publishUrl);
    ...
    private String genPublishURL() {
        ...
        if (publishUrl == null) {
            Util.showToast(QiNiuActivity.this, "Get publish GENERATE_STREAM_TEXT failed !!!");
            return null;
        }
        return publishUrl;
    }
    ...
    private void updateInputTextView(final String url) {
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                Cache.saveURL(QiNiuActivity.this, url);
            }
        });
    }
